...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.bpo1.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.bpo1.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.bpo1.state.state_root
    [Trie]: ref:ethereum.forks.bpo1.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.bpo1.trie.root
    [Trie]: ref:ethereum.forks.bpo1.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.bpo1.bloom.logs_bloom
    """
    ...
    [crh]: ref:ethereum.forks.bpo1.requests.compute_requests_hash
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.bpo1.blocks.Header
    [withdrawals]: ref:ethereum.forks.bpo1.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.bpo1.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.bpo1.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.bpo1.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.bpo1.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.bpo1.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.bpo1.vm.instructions.log.log4
    """
