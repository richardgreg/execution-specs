...
def block_hash(evm: Evm) -> None:
    ...
    Raises
    ------
    :py:class:`~ethereum.forks.bpo1.vm.exceptions.StackUnderflowError`
        If `len(stack)` is less than `1`.
    :py:class:`~ethereum.forks.bpo1.vm.exceptions.OutOfGasError`
...
def coinbase(evm: Evm) -> None:
    ...
    Raises
    ------
    :py:class:`~ethereum.forks.bpo1.vm.exceptions.StackOverflowError`
